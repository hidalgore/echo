...
const styles = StyleSheet.create({
  ...
  scoreLabel: { color: 'rgba(255,255,255,0.45)', fontSize: 10, marginTop: 2, fontWeight: '800', textTransform: 'uppercase' },
  ...
  inputBtnText: { color: '#FFF', fontSize: 13, fontWeight: '800' },
  ...
  ledgerTitle: { color: '#FFF', fontSize: 13, fontWeight: '800' },
